...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
    ...
    case mine:
        return handleMineCardEffect(choice1, choice2, handPos, currentPlayer, state);
    case remodel:
    ...
    case baron:
        return handleBaronCardEffect(choice1, handPos, currentPlayer, state);
    case great_hall:
        //+1 Card
        drawCard(currentPlayer, state);
    ...
    case minion:
        return handleMinionCardEffect(choice1, choice2, handPos, currentPlayer, state);
    case steward:
        if (choice1 == 1)
        {
            //+2 cards
    ...
    case tribute:
        return handleTributeCardEffect(currentPlayer, nextPlayer, state);
    case ambassador:
        return handleAmbassadorCardEffect(choice1, choice2, handPos, currentPlayer, state);
    case cutpurse:
...
{
    //int tribute_card = pile[nextPlayer][pileCount[nextPlayer]-1];
    int tribute_card = 1;  // fix
    //pile[nextPlayer][pileCount[nextPlayer]-1] = -1;
    pileCount[nextPlayer]--;
