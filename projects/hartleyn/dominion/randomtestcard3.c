...
int checkHandleTributeCardEffect(int choice1, int handPos, int currentPlayer, struct gameState *post) {
    struct gameState pre;
    memcpy (&pre, post, sizeof(struct gameState));

    int r;

    //r = handleTributeCardEffect();
...
int main () {
    ...
    printf ("Testing handleTributeCardEffect.\n");
